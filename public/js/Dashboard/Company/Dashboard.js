const mapInit =async () => {
    motorLoc = await fetch('/dashboard/company/FA/motorLoc');
...
const dataListRefresh = async ()=>{
    freshData = await fetch(`/dashboard/company/FA/motorsData`);
...
async function fetchAndProcessData() {
    try {
        // گرفتن داده از API
        const response = await fetch('/dashboard/company/FA/motorsDatas',{
