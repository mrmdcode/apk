                    ...
                    <li class="header-right-item">
                        <div class="dropdown notifications language">
                            <button class="btn btn-secondary border-0 p-0 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{\Illuminate\Support\Facades\Route::current()->getName() == 'company.dashboard.en'? asset('/assets/images/united-states.jpg') : asset('/assets/images/iran.jpg')}}" class="rounded-circle wh-22" alt="united-states">
                            </button>
                            <div class="dropdown-menu dropdown-lg p-0 border-0 p-4">
                                <div class="notification-menu">
                                    <a href="{{route('company.dashboard.en')}}" class="dropdown-item p-0">
                                ...
                                <div class="notification-menu">
                                    <a href="{{route('company.dashboard')}}" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('/assets/images/iran.jpg')}}" class="wh-22 rounded-circle" alt="iran">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h4>Persian</h4>
                                            </div>
