        ...
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <canvas class="flot-overlay" width="536" height="320"
                                    style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 536px; height: 320px;"></canvas>
                        </div>
                        <div class="col-lg-4">
                            <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-4">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ
                                        و با استفاده از طراحان گرافیک است.</p>
                                    <a href="#" class="btn btn-primary btn-sm">ادامه مطلب <i
