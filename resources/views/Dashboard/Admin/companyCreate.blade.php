           ...
           <form action="{{ route('admin.companyStore') }}" method="POST">
               ...
               <div class="form-row">
                   <div class="form-group col-md-6 @if($errors->has('company_name')) has-danger @endif">
                       ...
                       <input type="text" name="company_name" class="form-control" id="company_name" placeholder="نام شرکت">
                   ...
                   <div class="form-group col-md-6 @if($errors->has('company_registration_number')) has-danger @endif">
                       ...
                       <input type="text" name="company_registration_number" class="form-control" id="company_registration_number" placeholder="شماره ثبت شرکت">
               ...
               <div class="form-row">
                   ...
                   <div class="form-group col-md-6 @if($errors->has('email')) has-danger @endif">
                       ...
                       <input type="email" name="email" class="form-control" id="company_registration_number" placeholder="a@a.a">
                       @if($errors->has('email'))
                   ...
                   <div class="form-group col-md-6 @if($errors->has('password')) has-danger @endif">
                       ...
                       <input type="text" name="password" class="form-control" id="company_registration_number" placeholder="Aa- Zz- 0- 9">
                       @if($errors->has('company_registration_number'))
               ...
               <div class="form-row">
                   <div class="form-group col-md-6 @if($errors->has('company_address')) has-danger @endif">
                       ...
                       <input type="text" name="company_address" class="form-control" id="company_address" placeholder="آدرس شرکت">
                   ...
                   <div class="form-group col-md-6 @if($errors->has('legal_address_company')) has-danger @endif">
                       ...
                       <input type="text" name="legal_address_company" class="form-control" id="legal_address_company" placeholder="آدرس حقوقی شرکت">
               ...
               <div class="form-row">
                   <div class="form-group col-md-6 @if($errors->has('economic_code_company')) has-danger @endif">
                       ...
                       <input type="text" name="economic_code_company" class="form-control" id="economic_code_company" placeholder="کد اقتصادی شرکت">
                   ...
                   <div class="form-group col-md-6 @if($errors->has('postal_code_company')) has-danger @endif">
                       ...
                       <input type="text" name="postal_code_company" class="form-control" id="postal_code_company" placeholder="کد پستی شرکت">
               ...
               <div class="form-row">
                   <div class="form-group col-md-6 @if($errors->has('name_agent_company')) has-danger @endif">
                       ...
                       <input type="text" name="name_agent_company" class="form-control" id="name_agent_company" placeholder="نام نماینده شرکت">
                   ...
                   <div class="form-group col-md-6 @if($errors->has('phone_agent_company')) has-danger @endif">
                       ...
                       <input type="text" name="phone_agent_company" class="form-control" id="phone_agent_company" placeholder="تلفن نماینده شرکت">
               ...
               <div class="form-row">
                   <div class="form-group col-md-6 @if($errors->has('national_ID')) has-danger @endif">
                       ...
                       <input type="text" name="national_ID" class="form-control" id="national_ID" placeholder="کد ملی">
