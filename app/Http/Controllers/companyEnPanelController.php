...
class companyEnPanelController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $logs = $logs->count();
        return view('Dashboard.CompanyEN.dashboard',compact('company','logs','logsT','logsE','motor','lastmotor','motors'));
    }
    ...
    public function motorManager()
    {
        ...
        return view('Dashboard.CompanyEN.motorManager',compact('motors'));
    }
    ...
    public function motorView($motorId)
    {
        ...
        return view('Dashboard.CompanyEN.motorView',compact('motor','logs'));
    }
    ...
    public function motorData()
    {
        ...
        return view('Dashboard.CompanyEN.motorData',compact('logs'));
    }
    ...
    public function motorError()
    {
        $MCids =CompanyMotors::where('company_buyer_id',auth()->user()->company->id)
            ...
            ->pluck('id');
        $logs = MotorData::whereIn('motor_id',$MCids)->orderByDesc('created_at')->paginate(10);;
        return view('Dashboard.CompanyEN.motorError',compact('logs'));
    }
    ...
    public function motorEvent($motorId)
    {
        if ($this->motorCheck($motorId)['bool']){
            ...
            return view('Dashboard.CompanyEN.eventManager',compact('events'));
        }
        else
    ...
    {
        return view('Dashboard.CompanyEN.messages');
    }
